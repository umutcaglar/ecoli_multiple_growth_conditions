...
print(fig01)
cowplot::save_plot(filename = "../a_figures/qualityControl_mRNA.pdf",plot = fig01,ncol = 6,nrow = 8)
...
fig02<-ggplot2::ggplot(ratioDfL_summary_J,aes(x=sample_A, y=sample_B))+
  ...
  facet_wrap(~ uniqueCondition, ncol = 6, scales = "free")+

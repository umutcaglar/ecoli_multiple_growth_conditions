---
title: "Suplementary figures for significantly altered pathways"
...
Significantly altered pathways and significantly altered genes within the pathways with respect to different external conditions are shown. Gene alterations are ordered with repect to change in expression levels and filtered by log change and adjusted P values.<br />
<br />
Only<br />
(1) The genes that change more than 2 fold and with an adjusted p value less than 0.05 are shown.<br />
(2) The patways that change with an ajusted p value less than 0.05 are shown<br />
(3) If the number of genes that satisfy the property "1" is more than 15 only 15 of them are shown.<br />
(4) If the number of pathways that satisfy property "2" is more than 10 only 10 of them are shown<br />
<br />
<br />
<br />


```{r generate data set names that will be used for plots, include=FALSE}
###*****************************
...
\newpage
## Figures related with KEGG Pathway
```{r Generate KEGG figures within for loop, echo=FALSE, warning=FALSE, message=FALSE, fig.width=22, fig.height=7}
counter02=0
figureList=list()
rowNumberVec<-c()
for(counter01 in 1:length(differentCompartisonsList))
{
  ...
  if(paste0(objectName,"_kegg.csv") %in% dir("../c_results/david_results/"))
  {
    ...
    if(nrow(kegg_result_tidy)!=0)
    {
      ...
      ###*****************************
      # Save figure
      rowWidth=rowNumberVec[counter02]
      if(rowWidth<3){rowWidth=3}
      
      cowplot::save_plot(filename = paste0("../d_figures/kegg_",sprintf("%02d",counter02),".pdf"),
                         plot = figAA,
                         ncol=2.5,
                         nrow=0.4*rowWidth,
                         limitsize = FALSE)
...
\caption[kegg_01]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_02.pdf}
\caption[kegg_02]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_03.pdf}
\caption[kegg_03]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_04.pdf}
\caption[kegg_04]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_05.pdf}
\caption[kegg_05]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_06.pdf}
\caption[kegg_06]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_07.pdf}
\caption[kegg_07]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_08.pdf}
\caption[kegg_08]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_09.pdf}
\caption[kegg_09]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_10.pdf}
\caption[kegg_10]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_11.pdf}
\caption[kegg_11]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_12.pdf}
\caption[kegg_12]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_13.pdf}
\caption[kegg_13]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_14.pdf}
\caption[kegg_14]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_15.pdf}
\caption[kegg_15]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/kegg_16.pdf}
\caption[kegg_16]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage


```{r Generate MF figures within for loop, echo=FALSE, warning=FALSE, message=FALSE, fig.width=22, fig.height=11}
## Figures related with GO annotations related with molecular function
  ...
  if(paste0(objectName,"_mf_n.csv") %in% dir("../c_results/david_results/"))
  {
    ...
    if(nrow(mf_result_tidy)!=0)
    {
      ...
      figAA=ggplot(mf_tidy_organized_simp, aes( x=log2,y=MF_Short_2Line)) +
        ...
        geom_vline(xintercept = c(log2(1)), colour="black", linetype = "longdash")+
        geom_text_repel(aes(label=gene_name),size=3, colour="Black", fontface="plain")+
        ggtitle(paste0("Significatly altered GO annotations associated with MF ", phaseChoice, " ",dataTypeChoice,"\nTest For: ", test_forChoice, " ", test_contrastChoice, "_VS_", test_baseChoice))+
        theme_bw()+
        scale_x_continuous(breaks=seq(floor(minimumFold),ceiling(maximumFold)))+
        xlab("Log2 Fold Change")+
        theme(axis.line.y = element_blank(),
      ...
      cowplot::save_plot(filename = paste0("../d_figures/mf_n_",sprintf("%02d",counter02),".pdf"),
                         plot = figAA,
                         ncol=2.5,
                         nrow=0.4*rowWidth,
                         limitsize = FALSE)
...
\section{Figures related with GO Annotations associated with Molecular Function}
\begin{figure}[!htb]
\includegraphics[width=1.0\textwidth]{../d_figures/mf_n_01.pdf}
\caption[mf_n_01]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/mf_n_02.pdf}
\caption[mf_n_02]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/mf_n_03.pdf}
\caption[mf_n_03]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/mf_n_04.pdf}
\caption[mf_n_04]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

\clearpage
\begin{figure}
\includegraphics[width=1.0\textwidth]{../d_figures/mf_n_05.pdf}
\caption[mf_n_05]{Sèries temporals velocitat de vent       direccions. filtratge de pics i glaçades de velocitat.}
\end{figure}

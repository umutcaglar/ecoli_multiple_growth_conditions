...
\paragraph*{Supplementary Table S2:} Normalized mRNA counts. Includes data for 4197 distinct proteins each for 152 samples.\\

\noindent File name: tableS2\_mRNA\_normalized\_raw\_data.csv

\paragraph*{Supplementary Table S3:} Normalized protein counts. Includes data for 4197 distinct proteins each for 105 samples.\\

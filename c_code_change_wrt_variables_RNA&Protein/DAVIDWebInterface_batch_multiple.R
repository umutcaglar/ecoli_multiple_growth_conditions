...
for(i in list.files(pattern="*.csv$", path = "../c_results/david_results_batch/"))  # iterate i over .csv files
{
  if(R.utils::countLines(paste0("../c_results/david_results_batch/",i))==0)
  {
    file.remove(paste0("../c_results/david_results_batch/",i)) #delete the ones with 0 lines.
  }
  if(file.info(paste0("../c_results/david_results_batch/",i))$size<=3)
  {
    file.remove(paste0("../c_results/david_results_batch/",i)) #delete the ones with 3 bytes.
  }
} 

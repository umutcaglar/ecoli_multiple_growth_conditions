...
resultList=dir("../c_results/DeSeq2_diffGene_batchGrowth_Results/")
...
{
  temp=read.csv(file = paste0("../c_results/DeSeq2_diffGene_batchGrowth_Results/",
...
###*****************************
# Save Figure
cowplot::save_plot(filename = paste0("../c_figures/difExpressedGenesBatchGrowth",".pdf"),
                   plot = figBarGraph01, 
                   ncol = 2, nrow = 2, 
                   base_height = 3.075,base_width = 4.5,
                   units = "in",useDingbats=FALSE)

cowplot::save_plot(filename = paste0("../c_figures/difExpressedGenesBatchGrowth_mrna",".pdf"),
                   plot = figBarGraph02a, 
                   ncol = 2, nrow = 1, 
                   base_height = 4,base_width = 4.5,
                   units = "in",useDingbats=FALSE)

cowplot::save_plot(filename = paste0("../c_figures/difExpressedGenesBatchGrowth_protein",".pdf"),
                   plot = figBarGraph02b, 
                   ncol = 2, nrow = 1, 
                   base_height = 4,base_width = 4.5,
                   units = "in",useDingbats=FALSE)
...
venn.grid = venn.diagram(x=exp_mrna_list, filename="../c_figures/exp_mrna_batchGrowth_venn.jpeg", 
...
venn.grid = venn.diagram(x=exp_protein_list, filename="../c_figures/exp_protein_batchGrowth_venn.jpeg", 
                         euler.d=FALSE,scaled=FALSE,
                         print.mode=c("raw","percent"),force.unique=TRUE, 
                         fill=c("purple","cyan","orange"), 
                         fontface = "bold", cex=rep(mainTextFontSizeVector,7), cat.fontface="bold", 
...
venn.grid = venn.diagram(x=sta_mrna_list, filename="../c_figures/sta_mrna_batchGrowth_venn.jpeg", 
                         euler.d=FALSE,scaled=FALSE,
                         print.mode=c("raw","percent"),force.unique=TRUE, 
                         fill=c("purple","cyan","orange"), 
                         fontface = "bold", cex=rep(mainTextFontSizeVector,7), cat.fontface="bold", 
...
venn.grid = venn.diagram(x=sta_protein_list, filename="../c_figures/sta_protein_batchGrowth_venn.jpeg", 
                         euler.d=FALSE,scaled=FALSE,
                         print.mode=c("raw","percent"),force.unique=TRUE, 
                         fill=c("purple","cyan","orange"), 
                         fontface = "bold", cex=rep(mainTextFontSizeVector,7), cat.fontface="bold", 
...
#**************************************
png(filename = '../c_figures/venn_batchGrowth.png',width = 6600, height = 6600, units="px", res =500)
...
#**************************************
pdf(file = '../c_figures/venn_batchGrowth.pdf',width = 14, height = 14)
pushViewport(viewport(layout=grid.layout(ncol=3,nrow = 3, 
                                         widths = unit(c(5,5,1)/11, "npc"), 
                                         heights = unit(c(1,5,5)/11, "npc")
)))

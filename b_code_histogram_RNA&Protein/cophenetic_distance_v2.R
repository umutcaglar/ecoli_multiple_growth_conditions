...
source("cophenetic_distance_functions_v2.R")
###*****************************
...
distance_df_real=as.data.frame(as.matrix(dist_x))
###*****************************


###*****************************
# Generate additional columns for condition summary
colNamesCDM=colnames(cophenetic_distance_df_real)
rowNamesCDM=row.names(cophenetic_distance_df_real)
...
growth_real<-calculateClusterMeans(variableInput="growthPhase",
                                   ...
                                   mainDataFrame=cophenetic_distance_df_real)
...
#********************************
write.csv(x = z_scores,file = paste0("../b_results/",clusteringDataName,"_v2.csv"),row.names = F,quote = TRUE)
#********************************

...
listColors=c("#bcbddc","#9e9ac8","#807dba","#6a51a3", # carbon
             "#fdbe85","#fd8d3c", # Na
             "#bae4b3","#74c476","#238b45", #growth
...
newLevels=replace_fun(input_vector = oldLevels, 
                      initialVal = c("glucose","glycerol","lactate","gluconate",
                                     "baseNa","highNa",
                                     "exponential","stationary","late_stationary",
                                     "lowMg","baseMg","highMg"), 
                      finalVal=c("Glucose", "Glycerol", "Lactate", "Gluconate",
                                 "Base Na", "High Na", 
...
figureName=paste0("../b_figures/",heatMapName,"DIFFOrder.png")
cowplot::save_plot(plot = figComb, filename = figureName, ncol = 4,nrow = 3, dpi=300)

cowplot::save_plot(plot = figComb, filename = "../b_figures/proteinHeatmapDIFFOrder.pdf",ncol = 4,nrow = 3, dpi=300)
